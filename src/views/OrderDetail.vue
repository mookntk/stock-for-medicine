   ...
   <v-layout >
    <v-flex d-flex xs12 sm6 md4>
        <v-layout column align-end justify-start>
            <v-btn width="200px" class="blue-grey lighten-3" value="all" @click="sortdata">
                ALL
            </v-btn>
            <v-btn width="200px" class="green lighten-1" value="success" @click="sortdata">
                SUCCESS
            </v-btn>
            <v-btn  width="200px" class="orange lighten-1" value="ongoing" @click="sortdata">
                ONGOING
            </v-btn>
            <v-btn  width="200px" class="red lighten-1" value="cancel" @click="sortdata">
                CANCEL
            </v-btn>
        </v-layout>
    </v-flex>
